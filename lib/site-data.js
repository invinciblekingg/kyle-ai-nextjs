...
export const liveActivity = [
  { time: "00:12", title: "Waste reported in Delhi", detail: "Route intelligence clustered the signal automatically." },
  { time: "00:28", title: "Route optimized", detail: "AI shifted the pickup sequence to reduce idle time." },
  { time: "00:44", title: "Pickup completed", detail: "The system closed the loop and updated the live board." },
  { time: "01:05", title: "Board pack refreshed", detail: "Executive view updated with the latest margin impact." },
];

export const heroSignals = [
  { label: "Connected Sources", value: "38" },
  { label: "Alerts Resolved", value: "14" },
  { label: "Live Optimizations", value: "09" },
];

export const systemInsights = [
  "AI watches performance changes in real time.",
  "Signals flow into recommendations without manual handoff.",
  "Every action updates the next layer of the system.",
];
